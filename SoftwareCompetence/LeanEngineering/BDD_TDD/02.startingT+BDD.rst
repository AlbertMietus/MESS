...
The last question of today is should I start? Today, that is still an option.
|BR|
But will it be in the future? How long do you have the option to choose?

Albeit applying B&TDD in Modern Embedded System Software especially with huge, aged codebases is not trivial, using Test
Driven Development speeds up your team -- some claim 30%. And it results in beter code, with lower maintenance
costs. Likewise, Behavior Driven Development
