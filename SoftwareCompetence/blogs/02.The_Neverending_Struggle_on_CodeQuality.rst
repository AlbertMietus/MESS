...
.. post:: 2023/04/23
   ...
   the number of developers will roughly double the risk of mistakes.  We need to learn new *“tricks”* to strive for the
   demanded high quality.
   |BR|
   This is a constant battle. Embracing tools, processes or disciplines helps only once.
...
complex then some time ago. See e.g. :ref:`WhyPrinters_with_EmbeddedWeb`. Also “external” code increases the risk on
errors.
...
in terms of *“risks on mistakes”* and constantly lower that risk. When we can lower the risk of errors by 60% (or at
least 50%) by introducing a new “trick” that will compensate for the raise due to doubling.

There is no single solution to this challenge. Instead, teams must constantly adapt and employ new techniques to ensure
that quality is stable (or raise) as team and code size constantly doubles.
...
your tests.
|BR|
This really works but needs a lot of computertime. As we run all tests a zillion times. Slowly, this becomes feasible.
...
By embracing these and other techniques, software teams can manage the growing pains of expanding codebases and teams
while maintaining high standards for quality and reliability in their embedded systems.
